        ...
        "series": [
            {
                ...
                "type": "scatter",
                "data": [],
                "symbolSize": JsCode("function(dataItem){return dataItem[1]*4}").js_code,
            }
            for idx, _ in enumerate(days)
        ],
    }
...
ST_SCATTER_DEMOS = {
    "Scatter: Basic Scatter Chart": (render_scatter_simple),
    "Scatter: Anscombe's Quartet": (render_anscombe_quartet),
    "Scatter: Scatter Single Axis": (render_scatter_single_axis),
}
